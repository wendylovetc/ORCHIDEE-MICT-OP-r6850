...
MODULE mod_orchidee_omp_transfert
  ...
  !_ ================================================================================================================================
  INTERFACE scatter_omp
     MODULE PROCEDURE scatter_omp_i,scatter_omp_i1,scatter_omp_i2,scatter_omp_i3,scatter_omp_i4, &
          scatter_omp_r,scatter_omp_r1,scatter_omp_r2,scatter_omp_r3,scatter_omp_r4, &
          scatter_omp_l,scatter_omp_l1,scatter_omp_l2,scatter_omp_l3,scatter_omp_l4
  END INTERFACE
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  SUBROUTINE scatter_omp_i4(VarIn, VarOut)
...
#else    
    CALL check_buffer_i(size(VarIn))   
    CALL orch_scatter_omp_igen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4)*SIZE(VarOut,5),omp_ibuffer)
#endif  
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_omp_i4
  ...
  SUBROUTINE scatter_omp_r4(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarIn))   
    CALL orch_scatter_omp_rgen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4)*SIZE(VarOut,5),omp_rbuffer)
#endif  
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_omp_r4
  ...
  SUBROUTINE scatter_omp_l4(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarIn))   
    CALL orch_scatter_omp_lgen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4)*SIZE(VarOut,5),omp_lbuffer)
#endif  
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_omp_l4
...
#else
    CALL check_buffer_i(1)   
    CALL orch_reduce_sum_omp_igen_scal(VarIn,Varout,omp_ibuffer(1))
#endif  
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
...
#else
    CALL check_buffer_r(1)   
    CALL orch_reduce_sum_omp_rgen_scal(VarIn,Varout,omp_rbuffer(1))
#endif  
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
...
SUBROUTINE orch_reduce_sum_omp_igen_scal(VarIn,VarOut,Buff)
  USE mod_orchidee_omp_data
...
!$OMP END CRITICAL
  ...
  IF ( check_all_transfert ) &
      omp_function(omp_rank)=omp_previous
END SUBROUTINE orch_reduce_sum_omp_igen_scal
...
SUBROUTINE orch_reduce_sum_omp_rgen_scal(VarIn,VarOut,Buff)
  USE mod_orchidee_omp_data
...
!$OMP END CRITICAL
  ...
  IF ( check_all_transfert ) &
      omp_function(omp_rank)=omp_previous
END SUBROUTINE orch_reduce_sum_omp_rgen_scal
