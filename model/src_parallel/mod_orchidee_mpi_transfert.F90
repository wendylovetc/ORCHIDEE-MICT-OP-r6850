...
#include "src_parallel.h"
  ...
  !! \n
  !_ ================================================================================================================================
  INTERFACE allreduce_sum_mpi
     MODULE PROCEDURE allreduce_sum_mpi_r
  END INTERFACE
CONTAINS
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!! Definition of all_reduce_sum      !!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  SUBROUTINE allreduce_sum_mpi_r(VarIn, VarOut)
    IMPLICIT NONE
    ...
    Var1(1)=VarIn
!    IF (is_mpi_root) THEN
       CALL orch_allreduce_sum_mpi_rgen(Var1,Var2,1)
       VarOut=Var2(1)
!    ELSE
...
#endif
  END SUBROUTINE allreduce_sum_mpi_r
