...
!_ ================================================================================================================================
  ...
  !! 0. Variable and parameter declaration
    ...
    REAL(r_std),DIMENSION (kjpindex,nslm), INTENT (out)   :: shumdiag         !! Mean relative soil moisture in the different
...
!_ ================================================================================================================================
  ...
  SUBROUTINE hydrolc_main (kjit, kjpindex, index, indexveg, &
     & temp_sol_new, floodout, run_off_tot, drainage, frac_nobio, totfrac_nobio, contfrac, vevapwet, veget, veget_max,&
  ...
  !! 0. Variable and parameter declaration
    ...
    REAL(r_std),DIMENSION (kjpindex,nslm), INTENT (inout)   :: shumdiag         !! Mean relative soil moisture in the different
                                                                                !! levels used by thermosoil.f90 (0-1, unitless)
...
!_ ================================================================================================================================
  ...
  SUBROUTINE hydrolc_finalize( kjit,      kjpindex,   rest_id,        snow,       &
    ...
    REAL(r_std),DIMENSION (kjpindex,nslm),INTENT(in)     :: shumdiag
!_ ================================================================================================================================
...
!_ ================================================================================================================================  
  ...
  !! 0. Variable and parameter declaration
    ...
    REAL(r_std),DIMENSION (kjpindex), INTENT (out)     :: ruu_ch        !! Volumetric soil water capacity 
                                                                        !! @tex ($kg m^{-3}$) @endtex
    REAL(r_std),DIMENSION (kjpindex,nslm), INTENT (inout):: shumdiag    !! Mean relative soil moisture, diagnosed for 
    ...
    REAL(r_std), DIMENSION(nslm+1)                     :: tmp_dl        !! Temporary diagnostic levels in the soil (m)
!_ ================================================================================================================================
...
!_ ================================================================================================================================
  ...
  !! 0. Variable and parameter declaration
    ...
    REAL(r_std), DIMENSION (kjpindex, nvm), INTENT(out) :: vegstress      !! Vegetation moisture stress (only for vegetation
                                                                          !!  growth) (0-1, unitless)
    REAL(r_std),DIMENSION (kjpindex,nslm), INTENT (out) :: shumdiag       !! Mean relative soil moisture in the different levels 
