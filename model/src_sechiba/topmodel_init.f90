...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/perso/shushi.peng/ORCHIDEE/src_sechiba/topmodel_init.f90 $
...
!
!     ######spl
      SUBROUTINE topmodel_init_main(kjpindex, lalo, veget_max, PWWILT, PWSAT, PD_TOP, PM, PTI_MIN, PTI_MAX, &
...
!-------------------------------------------------------------------------------
!
END SUBROUTINE topmodel_init_main 
!
!*******************************************
!*           FUNCTION  GAMMA(X)            *
!* --------------------------------------- *
