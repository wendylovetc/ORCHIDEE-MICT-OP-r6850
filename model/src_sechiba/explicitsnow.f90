...
!================================================================================================================================
 SUBROUTINE explicitsnow_main(kjpindex,     precip_rain,   precip_snow,    temp_air,    pb,           & ! in 
                              ...
                              temp_sol_add,                                                           & ! inout
                              snowliq,      subsnownobio, grndflux,      snowmelt,       tot_melt,    & ! out
                              soilflxresid, subsinksoil)                                                ! out
    ...
    !! 0.2 Output fields
    REAL(r_std), DIMENSION (kjpindex), INTENT(inout)         :: snowmelt         !! Snow melt [mm/dt_sechiba]
