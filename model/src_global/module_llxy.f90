MODULE module_llxy
!!
!! Changes for ORCHIDEE
!!
!! - PI becomes PI_M so that it does not conflict with ORCHIDEE
!! - Put a use for IOIPSL
!! - added wrf_error_fatal is replaced by ipslerrsubroutine to redirect to ipslerr
!!
!!  Jan Polcher
!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   REAL, PARAMETER :: DEG_PER_RAD = 180./PI_M
   REAL, PARAMETER :: RAD_PER_DEG = PI_M/180.
   ...
   REAL, PARAMETER :: EARTH_RADIUS_M = R_Earth
   REAL, PARAMETER :: EARTH_CIRC_M = 2.*PI_M*EARTH_RADIUS_M

   INTEGER, PUBLIC, PARAMETER  :: PROJ_CASSINI = 0
...
!      END IF
   ...
   SUBROUTINE wrf_error_fatal(str)
     ...
     CALL ipslerr(3, str, "Error redirected from wrf_error_fatal in modile_llxy","","")
